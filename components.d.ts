...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DataTable: typeof import('./src/components/payments/data-table.vue')['default']
    DataTableDropdown: typeof import('./src/components/payments/data-table-dropdown.vue')['default']
